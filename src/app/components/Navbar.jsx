...
>
  <div className="max-w-7xl mx-auto py-4 flex items-center justify-between">
    ...
    <Link href="/" className="flex items-center">
      <h1
        className={`text-xl font-semibold ${
          isProjectsPage ? "text-blue-600" : "text-blue-400"
        }`}
      >
        Portfolio
    ...
    <div
      className={`hidden md:flex items-center gap-12 font-medium ${
        isProjectsPage ? "text-gray-600" : "text-white"
      }`}
    >
      <Link
        href="/"
  ...
  {open && (
    <div
      className={`md:hidden px-4 md:px-10 lg:px-20 pb-6 flex flex-col gap-6 font-medium ${
        isProjectsPage
