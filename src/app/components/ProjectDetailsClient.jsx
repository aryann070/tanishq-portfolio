              ...
              <section className="mb-10">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between bg-blue-50 border border-blue-200 rounded-2xl px-5 py-5 md:px-8 md:py-6 gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-4 rounded-xl transition w-full md:w-50"
                  >
                    <FileText size={20} />
